...
class KPPickerView: UIView {
    ...
    private func show(_ parentVC: UIViewController , sender: UIView) {
        ...
        objPopOverController!.preferredContentSize = CGSize(width: min(bounds.size.width, UIScreen.main.bounds.width - 60.0), height: bounds.size.height)
    ...
    public func show(_ parentVC: UIViewController , sender: UIView, data: [String] , defaultSelected: String?, withCompletionBlock: @escaping pickerViewDoneButtonClick) {
